#----------------------------------------------------------------------------------------------------------------------------------------------------------------------#
# This julia file contains the definitions of the geometric quantities as well as the Hessian determinant that enter the amplitude of the effective cosmological model #
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------#

#----------------------------------------------

### Geometry and Regge action
...
### Ingredients for the Hessian determinant
...
### Hessian determinant in Sector I for vartheta not 1
...
### Hessian determinant in Sectors I and II at the identity
...
### Hessian determinant in Sector III
